...
const fields = [
  ...
  },
  {
    ...
    companies: [ { name: 'Nykaa', logo: nykaaLogo }, { name: 'Myntra', logo: myntraLogo } ]
  },
  {
    id: 4,
    image: Image4,
    ...
    companies: [ { name: 'EY', logo: eyLogo }, { name: 'Amazon', logo: amazonLogo } ]
  },
  {
    id: 5,
    image: Image5,
    ...
    companies: [ { name: 'Flipkart', logo: flipkartLogo }, { name: 'Delhivery', logo: delhiveryLogo } ]
  },
  {
    id: 6,
    image: Image6,
  ...
  },
  {
    ...
    companies: [ { name: 'Zendesk', logo: zendeskLogo }, { name: 'Intercom', logo: intercomLogo } ]
  },
];
